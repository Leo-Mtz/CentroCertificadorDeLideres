                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-12 text-center">
                            <h1 class="text-white animated slideInDown">Seleccione el estado de las certificaciones que desea consultar y de clic al botón denominado: Consultar</h1>
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "post">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary w-100 py-3" type="submit" name="consultar" >Consultar</button>
                        </div>
                    </div>
                </form>
                <?php
                     if(isset($_POST['consultar'])){
                        if($_POST['estado']!="Seleccionar estado"){
                            ...
                            if($conexion){
                                ...
                                $query = "SELECT * FROM certificaciones WHERE estado = ".$est.";";
                                ...
                                while($row = mysqli_fetch_array($certi)){
                                    echo "<tr>";
                                    echo "<td>".$row['IDCerti']."</td>";
                            ...
                            echo '<div class="alert alert-danger" role="alert">Seleccion un estado válido, intente de nuevo</div>';
                        }
                    }  
                  ?>
            </div>
