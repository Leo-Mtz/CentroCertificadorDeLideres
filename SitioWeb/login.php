<?php //Verifica si el usuario ya ha iniciado sesión
    session_start();
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="registroU.php" class="btn rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Registrarse</a>
                </div>
            </nav>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-12 text-center">
                            <h1 class="text-white animated slideInDown">Inicio de Sesión</h1>
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container py-5 px-lg-5">
                <form action ="proyectoLogIn.php" method = "post">
                    <div class="row g-3">
                        <div class="col-12">
