            ...
            <div class="container py-5 px-lg-5">
                <div class="bricks-wrapper">
                    ...
                    <article class="brick entry format-standard animate-this">
                      ...
                      <div class="entry-text">
                          <div class="entry-header">
                              <h1 class="entry-title"><a href="registroUA.php">Registro Administrador </a></h1>
                          </div>
                               <div class="entry-excerpt">
                                    Crea la cuenta de un nuevo usuario administrador.
                               </div>
                      </div>
                   ...
                   <article class="brick entry format-standard animate-this">
                      <div class="entry-text">
                          <div class="entry-header">
                              <h1 class="entry-title"><a href="registroC.php">Registro Certificación</a></h1>
                          </div>
                               <div class="entry-excerpt">
                                    Registro en plataforma de una nueva certificación.
                               </div>
                      </div>
                    </article> <!-- end article -->
                    ...
                    <article class="brick entry format-standard animate-this">
                        ...
                        <div class="entry-text">
                            <div class="entry-header">
                                <h1 class="entry-title"><a href="consultaCertiUA.php">Consulta Certificaciones</a></h1>
                            </div>
                                 <div class="entry-excerpt">
                                      Consulta las certificaciones registradas en el sistema.
                                 </div>
                        </div>
                ...
                <div class="bricks-wrapper">
                        ...
                        <article class="brick entry format-standard animate-this">
                            ...
                            <div class="entry-text">
                                <div class="entry-header">
                                    <h1 class="entry-title"><a href="eliminaU.php">Cambia Estado de Usuario</a></h1>
                                </div>
                                     <div class="entry-excerpt">
                                          Cambia el estado (Activo/Inactivo) actual de un usuario registrado en el sistema.
                                     </div>
                            </div>
                        </article> <!-- end article --> 
                        </div>
                        ...
                        <article class="brick entry format-standard animate-this">
                            ...
                            <div class="entry-text">
                                <div class="entry-header">
                                    <h1 class="entry-title"><a href="modificaC.php">Modificación de Certificación</a></h1>
                                </div>
                                     <div class="entry-excerpt">
                                        Modifica los datos de una certificación registrada en el sistema.
                                     </div>
                            </div>
                        </article> <!-- end article -->      
                </div>
