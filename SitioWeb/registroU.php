        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="login.php" class="btn rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Identifícate</a>
                </div>
            </nav>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-12 text-center">
                            <h1 class="text-white animated slideInDown">Crear Cuenta</h1>
                                ...
                                if ($conn->connect_error) {
                                    ...
                                    if($result->num_rows == 1 || $_POST['ciudad']=="Seleccionar estado"){
                                        ...
                                        if($conexion){
                                            ...
                                            ('".$_POST['correo']."', '".$_POST['pass']."', '".$_POST['nombre']."', '".$_POST['apellidos']."', '".$_POST['telefono']."', '".$_POST['ciudad']."', 2, 1);";
